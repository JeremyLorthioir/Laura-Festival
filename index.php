...
<body>
  ...
  <form action="traitement.php" id="inscription" method="POST">
    ...
    <fieldset id="options">
      ...
      <input type="radio" id="tenteNuit1" name="tenteNuit1" class="tenteNuit" value="tenteNuit1"
        onchange="cocherTente3nuits()">
      <label for="tenteNuit1">Pour la nuit du 01/07 (5€)</label>
      <input type="radio" id="tenteNuit2" name="tenteNuit2" class="tenteNuit" value="tenteNuit2"
        onchange="cocherTente3nuits()">
      <label for="tenteNuit2">Pour la nuit du 02/07 (5€)</label>
      <input type="radio" id="tenteNuit3" name="tenteNuit3" class="tenteNuit" value="tenteNuit3"
        onchange="cocherTente3nuits()">
      <label for="tenteNuit3">Pour la nuit du 03/07 (5€)</label>
      <input type="radio" id="tente3Nuits" name="tente3Nuits" class="tenteNuit" value="tente3Nuits"
        onchange="cocherTente3nuits()">
      ...
      <input type="radio" id="van3Nuits" name="van3Nuits" class="vanNuit" value="van3Nuits"
